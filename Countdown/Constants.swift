...
struct K {
    ...
    struct Emojis {
        ...
        static let categories: [Category] = [
            Category(name: "Emotions", icon: "😀", emojis: [
                "😀","😃","😄","😁","😆","😅","🤣","😂","🙂","🙃","😉","😊","😇","🥰","😍","🤩","😘","😗","😚","😙","🥲","😋","😛","😜","🤪","😝","🤑","🤗","🤭","🤫","🤔","🤐","🤨","😐","😑","😶","😏","😒","🙄","😬","🤥","😔","😪","🤤","😴","😷","🤒","🤕","🤢","🤮","🤧","🥵","🥶","🥴","😵","🤯","🤠","🥳","🥸","😎","🤓","🧐","😕","😟","🙁","☹️","😮","😯","😲","😳","🥺","😦","😧","😨","😰","😥","😢","😭","😱","😖","😣","😞","😓","😩","😫","🥱","😤","😡","😠","🤬","😈","👿","💀","☠️","💩","🤡","👹","👺","👻","👽","👾","🤖"
            ]),
            Category(name: "Animals", icon: "🐶", emojis: [
                "🐶","🐱","🐭","🐹","🐰","🦊","🐻","🐼","🐨","🐯","🦁","🐮","🐷","🐸","🐵","🙈","🙉","🙊","🐔","🐧","🐦","🦆","🦅","🦉","🦇","🐺","🐗","🐴","🦄","🐝","🦋","🐌","🐞","🐜","🐢","🐍","🦎","🐙","🦑","🦐","🦀","🐡","🐠","🐟","🐬","🐳","🐋","🦈","🐊","🐅","🐆","🦓","🐘","🦛","🦏","🐪","🐫","🦒","🦘","🐃","🐂","🐄","🐎","🐖","🐏","🐑","🦙","🐐","🦌","🐕","🐩","🦮","🐈","🐓","🦃","🦚","🦜","🦩","🦢","🕊️","🐇","🦝","🦨","🦡","🦦","🦥","🐁","🐀","🐿️","🦔"
            ]),
            Category(name: "Food", icon: "🍕", emojis: [
                "🍕","🍔","🌮","🌯","🥗","🍣","🍜","🍝","🍛","🍲","🥘","🫕","🍱","🍤","🍗","🥩","🥓","🍟","🌭","🥪","🧆","🥚","🍳","🧇","🥞","🧈","🥐","🍞","🥨","🧀","🍿","🧂","🍩","🍪","🎂","🍰","🧁","🍫","🍬","🍭","🍮","🍯","🍎","🍊","🍋","🍇","🍓","🫐","🍒","🍑","🥭","🍍","🥥","🫧","🧃","🥤","☕️","🍵","🧋","🍺","🍻","🥃","🍷","🍸","🍹"
            ]),
            Category(name: "Activities", icon: "⚽️", emojis: [
                "⚽️","🏀","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥊","🥋","⛷️","🏂","🏋️","🤸","🏊","🚴","🧗","🤺","🏇","🧘","🎯","🎳","🎮","🕹️","🎲","♟️","🎭","🎨","🎬","🎤","🎸","🎹","🎺","🎻","🥁","🎧","🎼"
            ]),
            Category(name: "Objects", icon: "💡", emojis: [
                "💡","🔦","🕯️","💰","💳","💎","⚖️","🔧","🔨","⚒️","🛠️","⛏️","🔩","🪛","🏹","🛡️","🪚","🔪","⚔️","🧲","🪜","🧰","🪝","💊","🩺","🩹","🩻","🔬","🔭","📡","💻","🖥️","⌨️","🖱️","💾","💿","📀","📱","☎️","📞","📟","📠","📺","📻","🧭","⏱️","⏰","⏳","📷","📸","📹","🎥","📽️","🎞️","🔋","🔌","📚","📖","📝","✏️","🖊️","🖋️","📌","📍","📎","🖇️","✂️","🗃️","🗄️","🗑️","🔐","🔒","🔓","🔏","🗝️","🔑","🚪","🪑","🛋️","🚿","🛁","🧴","🧷","🧹","🧺","🧻","🪣","🧼","🫧","🪥","🧽","🧯","🛒"
            ]),
            Category(name: "Trips", icon: "✈️", emojis: [
                "✈️","🚀","🛸","🚁","⛵️","🚢","🚂","🚗","🏎️","🚕","🛻","🏍️","🛵","🚲","🛴","🏖️","🏝️","🏔️","🗻","🌋","🏕️","🗼","🗽","🏰","🏯","🗿","🌁","🌉","🌃","🎡","🎢","🌍","🌎","🌏","🧳","🗺️","🧭","⛽️","🅿️"
            ]),
            Category(name: "Party", icon: "🎉", emojis: [
                "🎉","🎊","🎈","🎂","🎁","🎀","🪅","🎆","🎇","✨","🥂","🍾","🎓","💍","💒","🪄","🎪","🎠","🎟️","🎫","🏆","🥇","🥈","🥉","🎖️","🏅","🎗️","🎑","🎃","🎄","🎋","🎍","🎎","🎏","🎐","🧨","🪔","🕯️"
            ]),
            Category(name: "Flags", icon: "🏳️", emojis: [
